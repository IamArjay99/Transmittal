                    ...
                    <div class="col-md-6">
                        <div class="card activity-panel">
                                    ...
                                    <ul class="activity-list">
                                        <li>
                                            <div class="activity-user">
                                                <a href="profile.html.htm" title="Lesley Grauer" data-toggle="tooltip" class="avatar">
                                                    <img alt="Lesley Grauer" src="assets/img/user.jpg" class="img-fluid rounded-circle">
                                                </a>
                                            </div>
                                            <div class="activity-content">
                                                <div class="timeline-content">
                                                    <a href="profile.html.htm" class="name">Lesley Grauer</a> added new task <a href="#">Hospital Administration</a>
                                        ...
                                        <li>
                                            <div class="activity-user">
                                                <a href="profile.html.htm" class="avatar" title="Jeffery Lalor" data-toggle="tooltip">L</a>
                                            </div>
                                            <div class="activity-content">
                                                <div class="timeline-content">
                                                    <a href="profile.html.htm" class="name">Jeffery Lalor</a> added <a href="profile.html.htm" class="name">Loren Gatlin</a> and <a href="profile.html.htm" class="name">Tarah Shropshire</a> to project <a href="#">Patient appointment booking</a>
                                        ...
                                        <li>
                                            <div class="activity-user">
                                                <a href="profile.html.htm" title="Catherine Manseau" data-toggle="tooltip" class="avatar">
                                                    <img alt="Catherine Manseau" src="assets/img/user.jpg" class="img-fluid rounded-circle">
                                                </a>
                                            </div>
                                            <div class="activity-content">
                                                <div class="timeline-content">
                                                    <a href="profile.html.htm" class="name">Catherine Manseau</a> completed task <a href="#">Appointment booking with payment gateway</a>
                                        ...
                                        <li>
                                            ...
                                            <div class="activity-content">
                                                <div class="timeline-content">
                                                    <a href="profile.html.htm" class="name">Bernardo Galaviz</a> changed the task name <a href="#">Doctor available module</a>
                                        ...
                                        <li>
                                            <div class="activity-user">
                                                <a href="profile.html.htm" title="Mike Litorus" data-toggle="tooltip" class="avatar">
                                                    <img alt="Mike Litorus" src="assets/img/user.jpg" class="img-fluid rounded-circle">
                                                </a>
                                            </div>
                                            <div class="activity-content">
                                                <div class="timeline-content">
                                                    <a href="profile.html.htm" class="name">Mike Litorus</a> added new task <a href="#">Patient and Doctor video conferencing</a>
                                        ...
                                        <li>
                                            <div class="activity-user">
                                                <a href="profile.html.htm" title="Jeffery Lalor" data-toggle="tooltip" class="avatar">
                                                    <img alt="Jeffery Lalor" src="assets/img/user.jpg" class="img-fluid rounded-circle">
                                                </a>
                                            </div>
                                            <div class="activity-content">
                                                <div class="timeline-content">
                                                    <a href="profile.html.htm" class="name">Jeffery Lalor</a> added <a href="profile.html.htm" class="name">Jeffrey Warden</a> and <a href="profile.html.htm" class="name">Bernardo Galaviz</a> to the task of <a href="#">Private chat module</a>
                            ...
                            <div class="card-footer text-center bg-white">
                                <a href="activities.html.htm" class="text-muted">View all activities</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                            ...
                            <div class="card-header bg-white">
								<div class="user-details">
									<div class="pull-left user-img m-r-10">
										<a href="profile.html.htm" title="Mike Litorus"><img src="assets/img/user.jpg" alt="" class="w-40 rounded-circle"><span class="status online"></span></a>
									</div>
									<div class="user-info pull-left">
										<a href="profile.html.htm" title="Mike Litorus"><span class="font-bold">Mike Litorus</span> <i class="typing-text">Typing...</i></a>
										<span class="last-seen">Last seen today at 7:50 AM</span>
									</div>
								</div>
								<ul class="nav pull-right custom-menu d-none d-lg-flex">
									<li class="nav-item">
										<a class="nav-link" href="voice-call.html.htm"><i class="fa fa-phone" aria-hidden="true"></i></a>
									</li>
									<li class="nav-item">
										<a class="nav-link" href="video-call.html.htm"><i class="fa fa-video-camera" aria-hidden="true"></i></a>
									</li>
                                ...
                                <div class="chats">
                                    ...
                                    <div class="chat chat-left">
                                        <div class="chat-avatar">
                                            <a href="profile.html.htm" class="avatar">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="card member-panel">
                                ...
                                <ul class="contact-list">
                                    <li>
                                        <div class="contact-cont">
                                            <div class="pull-left user-img m-r-10">
                                                <a href="profile.html.htm" title="John Doe"><img src="assets/img/user.jpg" alt="" class="w-40 rounded-circle"><span class="status online"></span></a>
                                            </div>
                                    ...
                                    <li>
                                        <div class="contact-cont">
                                            <div class="pull-left user-img m-r-10">
                                                <a href="profile.html.htm" title="Richard Miles"><img src="assets/img/user.jpg" alt="" class="w-40 rounded-circle"><span class="status offline"></span></a>
                                            </div>
                                            <div class="contact-info">
                                    ...
                                    <li>
                                        <div class="contact-cont">
                                            <div class="pull-left user-img m-r-10">
                                                <a href="profile.html.htm" title="John Doe"><img src="assets/img/user.jpg" alt="" class="w-40 rounded-circle"><span class="status away"></span></a>
                                            </div>
                                            <div class="contact-info">
                                                <span class="contact-name text-ellipsis">John Doe</span>
                                                <span class="contact-date">Web Developer</span>
                                    ...
                                    <li>
                                        <div class="contact-cont">
                                            <div class="pull-left user-img m-r-10">
                                                <a href="profile.html.htm" title="Richard Miles"><img src="assets/img/user.jpg" alt="" class="w-40 rounded-circle"><span class="status online"></span></a>
                                            </div>
                                            <div class="contact-info">
                                                <span class="contact-name text-ellipsis">Richard Miles</span>
                                                <span class="contact-date">Web Developer</span>
                                    ...
                                    <li>
                                        <div class="contact-cont">
                                            <div class="pull-left user-img m-r-10">
                                                <a href="profile.html.htm" title="John Doe"><img src="assets/img/user.jpg" alt="" class="w-40 rounded-circle"><span class="status offline"></span></a>
                                            </div>
                                            <div class="contact-info">
                                                <span class="contact-name text-ellipsis">John Doe</span>
                                                <span class="contact-date">Web Developer</span>
                                    ...
                                    <li>
                                        <div class="contact-cont">
                                            <div class="pull-left user-img m-r-10">
                                                <a href="profile.html.htm" title="Richard Miles"><img src="assets/img/user.jpg" alt="" class="w-40 rounded-circle"><span class="status away"></span></a>
                                            </div>
                                            <div class="contact-info">
                                                <span class="contact-name text-ellipsis">Richard Miles</span>
                                                <span class="contact-date">Web Developer</span>
                            ...
                            <div class="card-footer text-center bg-white">
                                <a href="users.html.htm" class="text-muted">View all members</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="card card-table card-table-top">
							...
							<div class="card-body p-0">
								<div class="table-responsive">
									<table class="table table-striped custom-table m-b-0">
										...
										<tbody>
											<tr>
												<td><a href="invoice-view.html.htm">#INV-0001</a></td>
												<td>
											...
											<tr>
												<td><a href="invoice-view.html.htm">#INV-0002</a></td>
												<td>
											...
											<tr>
												<td><a href="invoice-view.html.htm">#INV-0003</a></td>
												<td>
                            ...
                            <div class="card-footer text-center bg-white">
                                <a href="invoices.html.htm" class="text-muted">View all invoices</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="card card-table card-table-top">
							...
							<div class="card-body p-0">
								<div class="table-responsive">
									<table class="table table-striped custom-table m-b-0">
										...
										<tbody>
											<tr>
												<td><a href="invoice-view.html.htm">#INV-0004</a></td>
												<td>
											...
											<tr>
												<td><a href="invoice-view.html.htm">#INV-0005</a></td>
												<td>
											...
											<tr>
												<td><a href="invoice-view.html.htm">#INV-0006</a></td>
												<td>
                            ...
                            <div class="card-footer text-center bg-white">
                                <a href="payments.html.htm" class="text-muted">View all payments</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="card card-table">
									...
									<tbody>
										<tr>
											<td style="min-width:200px;">
												...
												<h2><a href="client-profile.html.htm">Barry Cuda <span>CEO</span></a></h2>
											</td>
										...
										<tr>
											<td>
												...
												<h2><a href="client-profile.html.htm">Tressa Wexler <span>Manager</span></a></h2>
											</td>
										...
										<tr>
											<td>
												<a href="client-profile.html.htm" class="avatar">R</a>
												<h2><a href="client-profile.html.htm">Ruby Bartlett <span>CEO</span></a></h2>
											</td>
										...
										<tr>
											<td>
												<a href="client-profile.html.htm" class="avatar">M</a>
												<h2><a href="client-profile.html.htm"> Misty Tison <span>CEO</span></a></h2>
											</td>
										...
										<tr>
											<td>
												<a href="client-profile.html.htm" class="avatar">D</a>
												<h2><a href="client-profile.html.htm"> Daniel Deacon <span>CEO</span></a></h2>
											</td>
                            ...
                            <div class="card-footer text-center bg-white">
                                <a href="clients.html.htm" class="text-muted">View all clients</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="card card-table">
							...
							<div class="table-responsive">
								<table class="table table-striped custom-table m-b-0">
									...
									<tbody>
										<tr>
											<td>
												<h2><a href="project-view.html.htm">Office Management</a></h2>
										...
										<tr>
											<td>
												<h2><a href="project-view.html.htm">Project Management</a></h2>
												<small class="block text-ellipsis">
										...
										<tr>
											<td>
												<h2><a href="project-view.html.htm">Video Calling App</a></h2>
												<small class="block text-ellipsis">
										...
										<tr>
											<td>
												<h2><a href="project-view.html.htm">Hospital Administration</a></h2>
												<small class="block text-ellipsis">
										...
										<tr>
											<td>
												<h2><a href="project-view.html.htm">Digital Marketplace</a></h2>
												<small class="block text-ellipsis">
                            ...
                            <div class="card-footer bg-white text-center">
                                <a href="projects.html.htm" class="text-muted">View all projects</a>
                            </div>
                        </div>
                    </div>
                </div>
